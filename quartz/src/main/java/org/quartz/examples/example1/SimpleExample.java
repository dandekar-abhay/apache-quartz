...
public class SimpleExample {
  ...
  public void run() throws Exception {
    ...
    System.out.println("Initing complete");
    ...
    Trigger trigger = newTrigger().withIdentity("trigger1", "group1").withSchedule(simpleSchedule()
							.withIntervalInSeconds(1)
							.repeatForever()).startAt(runTime).build();
